...
with open('/Volumes/Arquivos/Codigo/Contador/config.json') as fd:
    config = json.load(fd)
...
def get_access_token():
    ...
    with open('/Volumes/Arquivos/Codigo/Contador/auth2.json', 'w') as fd:
        json.dump(data, fd)


try:
    with open('/Volumes/Arquivos/Codigo/Contador/auth2.json') as fd:
